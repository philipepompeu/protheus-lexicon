...
-- Started on 2025-01-14 14:42:16
...
--DROP DATABASE protheuslexicon;
--
-- TOC entry 181220 (class 1262 OID 395581775)
-- Name: protheuslexicon; Type: DATABASE; Schema: -; Owner: -
-- Data Pos: 0
--

--CREATE DATABASE protheuslexicon WITH TEMPLATE = template0 ENCODING = 'WIN1252' LOCALE_PROVIDER = libc LOCALE = 'C' TABLESPACE = protheuslexicon;


--\connect protheuslexicon
...
--
-- TOC entry 268 (class 1259 OID 455468737)
-- Dependencies: 7
-- Name: sixt10; Type: TABLE; Schema: public; Owner: -
-- Data Pos: 0
--
